...
import { CardForm, defaultCardFormValues, type CardFormData } from "../../components";
      ...
      <Dialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
        <DialogContent className="sm:max-w-sm">
          ...
          <p className="text-sm text-muted-foreground py-2">
            ¿Estás seguro de que quieres eliminar <span className="font-medium text-foreground">{card.name}</span>?
          </p>
          <DialogFooter>
